...
COMPILACION
-----------
Para compilar el programa y impiar archivos generados:

    make clean && make

Para dar permiso a los script
    chmod +x *.sh
...
2. Pipeline parcial (2 scripts):
    ...
    ./lab2 ./generator.sh -i 1 -t 10 \| ./preprocess.sh \|

3. Solo procesos de gnome:

    ./lab2 ./generator.sh -i 1 -t 10 \| ./preprocess.sh \| ./filter.sh -c 5 -m 1 -r "gnome" \| ./transform.sh --anon-uid \| ./aggregate.sh \| ./report.sh -o reporte.csv

4. Filtrando por CPU a 5%:

    ./lab2 ./generator.sh -i 1 -t 10 \| ./preprocess.sh \| ./filter.sh -c 5 -m 0 \| ./transform.sh --anon-uid \| ./aggregate.sh \| ./report.sh -o reporte.csv

5. Filtrando de procesos que consuman al menos 1% de memoria:

   ./lab2 ./generator.sh -i 1 -t 5 \| ./preprocess.sh \| ./filter.sh -c 0 -m 1 \| ./transform.sh --anon-uid \| ./aggregate.sh \| ./report.sh -o reporte.csv
